...
is request type for the Query/Provider RPC method
...
is response type for the Query/Provider RPC method
...
is request type for the Query/Providers RPC method
...
is response type for the Query/Providers RPC method
...
### GenesisState
defines the basic genesis state used by provider module
...
### MsgCreateProvider
defines an SDK message for creating a provider
...
defines the Msg/CreateProvider response type.
...
### MsgDeleteProvider
defines an SDK message for deleting a provider
...
defines the Msg/DeleteProvider response type.
...
### MsgUpdateProvider
defines an SDK message for updating a provider
...
defines the Msg/UpdateProvider response type.
...
### AttributesResponse
represents details of deployment along with group details
...
defines the Msg/ProviderAttributes response type.
...
defines an SDK message for signing a provider attributes
...
is request type for the Query/All Providers RPC method
...
### GenesisState
defines the basic genesis state used by audit module
...
### GenesisState
stores slice of genesis deployment instance
...
### DenomTakeRate
describes take rate for specified denom
...
### Params
defines the parameters for the x/take package
...
defines the Msg/CloseGroup response type.
...
defines the Msg/PauseGroup response type.
...
defines the Msg/StartGroup response type.
...
### ResourceUnit
extends Resources and adds Count along with the Price
...
### Group
stores group id, state and specifications of group
...
### GroupID
stores owner, deployment sequence number and group sequence number
...
### Deployment
stores deploymentID, state and version details
...
### DeploymentID
stores owner and sequence number
...
is request type for the Query/Deployment RPC method
...
is response type for the Query/Deployment RPC method
...
is request type for the Query/Deployments RPC method
...
is response type for the Query/Deployments RPC method
...
### QueryGroupRequest
is request type for the Query/Group RPC method
...
### QueryGroupResponse
is response type for the Query/Group RPC method
...
### MsgCloseDeployment
defines an SDK message for closing deployment
...
defines the Msg/CloseDeployment response type.
...
### MsgCreateDeployment
defines an SDK message for creating deployment
...
defines the Msg/CreateDeployment response type.
...
deposits more funds into the deposit account
...
### MsgUpdateDeployment
defines an SDK message for updating deployment
...
defines the Msg/UpdateDeployment response type.
...
### Msg
defines the deployment  service.
...
allows the grantee to deposit up to spend_limit coins from
...
### GenesisDeployment
defines the basic genesis state used by deployment module
...
### Params
defines the parameters for the x/deployment package
...
### Resource
stores unit, total count and price of resource
...
### Params
extends the parameters for the x/staking module
...
### CertificateResponse
contains a single X509 certificate and its serial number
...
is response type for the Query/Certificates RPC method
...
### Certificate
stores state, certificate and it's public key
...
### CertificateFilter
defines filters used to filter certificates
...
defines an SDK message for creating certificate
...
defines the Msg/CreateCertificate response type.
...
defines an SDK message for revoking certificate
...
defines the Msg/RevokeCertificate response type.
...
### GenesisCertificate
defines certificate entry at genesis
...
### GenesisState
defines the basic genesis state used by cert module
...
### Account
stores state for an escrow account
...
### GenesisState
defines the basic genesis state used by escrow module
...
### Bid
stores ID, state of bid and price
...
### BidFilters
defines flags for bid list filter
...
### BidID
stores owner and all other seq numbers
...
### MsgCloseBid
defines an SDK message for closing bid
...
### MsgCloseBidResponse
defines the Msg/CloseBid response type.
...
### MsgCreateBid
defines an SDK message for creating Bid
...
defines the Msg/CreateBid response type.
...
### ResourceOffer
describes resources that provider is offering
for deployment
...
### QueryBidRequest
is request type for the Query/Bid RPC method
...
### QueryBidResponse
is response type for the Query/Bid RPC method
...
### QueryBidsRequest
is request type for the Query/Bids RPC method
...
### QueryBidsResponse
is response type for the Query/Bids RPC method
...
### QueryLeaseRequest
is request type for the Query/Lease RPC method
...
### QueryLeaseResponse
is response type for the Query/Lease RPC method
...
### QueryLeasesRequest
is request type for the Query/Leases RPC method
...
### QueryLeasesResponse
is response type for the Query/Leases RPC method
...
### QueryOrderRequest
is request type for the Query/Order RPC method
...
### QueryOrderResponse
is response type for the Query/Order RPC method
...
### QueryOrdersRequest
is request type for the Query/Orders RPC method
...
### QueryOrdersResponse
is response type for the Query/Orders RPC method
...
### Lease
stores ID, state of lease and price
...
### LeaseFilters
defines flags for lease list filter
...
### MsgCloseLease
defines an SDK message for closing order
...
defines the Msg/CloseLease response type.
...
is the response from creating a lease
...
defines the Msg/WithdrawLease response type.
...
### GenesisState
defines the basic genesis state used by market module
...
### Order
stores orderID, state of order and other details
...
### OrderFilters
defines flags for order list filter
...
### Params
is the params for the x/market module
...
### Memory
stores resource quantity and memory attributes
...
### CPU
stores resource units and cpu config attributes
...
### Resources
describes all available resources types for deployment/node etc
...
### SignedBy
represents validation accounts that tenant expects signatures for provider attributes
...
### Endpoint
describes a publicly accessible IP service
...
### Storage
stores resource quantity and storage attributes
...
### DepositParams
defines the parameters for the x/gov module
