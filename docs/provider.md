...
### Group
store name and list of services
...
### ServiceExpose
stores exposed ports and hosts details
...
### Service
stores name, image, args, env, unit, count and expose list of service
...
### ProviderRPC
defines the RPC server for provider
...
### Memory
reports Memory inventory details
...
### Cluster
reports inventory across entire cluster
...
### NodeResources
reports node inventory details
...
### NodeCapabilities
extended list of node capabilities
...
### ResourcePair
to extents resource.Quantity to provide total and available units of the resource
...
### GPU
Info reports GPU inventory details
...
### Storage
reports Storage inventory details
...
### ClusterRPC
defines the RPC server of cluster
...
### NodeRPC
defines the RPC server of node
